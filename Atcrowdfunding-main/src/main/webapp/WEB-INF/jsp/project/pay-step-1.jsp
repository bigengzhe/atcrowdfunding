                        ...
                        <div class="container-fluid">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 column">
                                    <table class="table table-bordered" style="text-align:center;">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>${myreturn.content }</td>
                                          <td><input type="text" class="form-control" style="width:60px;" value="1" readonly="readonly"></td>
                                          <td style="color:#F60">￥ 1.00</td>
                                          <td>
                                          	<c:choose>
                                          		<c:when test="${myreturn.freight=='0' }">免运费</c:when>
                                          		<c:otherwise>${myreturn.freight }</c:otherwise>
                                          	</c:choose>
                                          </td>
                                        </tr>
                                      </tbody>
                                    ...
                                    <p>总价(含运费)：<span style="font-size:16px;color:#F60;">￥${form.money }</span></p>
                                    <button type="button" class="btn btn-warning btn-lg" style="float:right;" onclick="window.location.href='${APP_PATH }/project/pay-step-2.htm?id=${ form.id }'"><i class="glyphicon glyphicon-credit-card"></i> 去结算</button>
                                    </div>
                                </div>
