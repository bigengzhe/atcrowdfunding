                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        <div class="col-md-8 column">
                            <img alt="140x140" width="740" src="${APP_PATH }/pics/project/${project.detailimgpath }" />
                        ...
                        <div class="col-md-4 column">
                            <div class="panel panel-default" style="border-radius: 0px;">
                                ...
                                <div class="panel-body">
                                    ...
                                    <p><span>目标金额 ： ${project.money }</span><span style="float:right;">达成 ： ${project.moneyProgress }%</span></p>
                                    <div class="progress" style="height:10px; margin-bottom: 5px;">
                                      <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${project.moneyProgress }%;"></div>
                                    </div>
                                    <p><c:choose><c:when test="${not empty project.deploydate }">开始日期： ${project.deploydate }</c:when><c:otherwise>未开始众筹</c:otherwise></c:choose>&nbsp;&nbsp;&nbsp;&nbsp; 持续时间：${project.day }天</p>
                                    <div>
					...
					<c:forEach items="${list }" var="myreturn">
						<div class="panel panel-default" style="border-radius: 0px;">
						<div class="panel-heading">
							<h3 >
								￥${myreturn.supportmoney } 
								<span style="float:right;font-size:12px;">
									<c:choose>
										<c:when test="${myreturn.count=='0' }">
											无限额
										</c:when>
										<c:otherwise>
											限额：${myreturn.count }
						...
						<div class="panel-body">
                            <p>配送费用：
	                            <c:choose>
	                            	<c:when test="${myreturn.freight==0 }">
	                            		包邮
	                            	</c:when>
	                            	<c:otherwise>
	                            		${myreturn.freight }
                            ...
                            <p>预计发放时间：项目筹款成功后的${myreturn.rtndate }天内</p>
                            <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${APP_PATH }/project/frontpay-step-1.htm?id=${myreturn.id }'">支持</button>
                            <br><br>
