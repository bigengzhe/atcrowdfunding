...
<script>
       ...
       $('#cardnum').blur(function (){
       	var val= $('#cardnum')[0].value;
       	var myval=val.match(/\d{14}\w{4}/)
       	if(val&&myval&&myval[0].length==val.length){
       		//alert(val+"  "+myval[0].length+"  "+val.length);do something
       	}else{
       		alert("身份证号不合法");
       	}
       });
       $('#tel').blur(function (){
       	var val= $('#tel')[0].value;
       	var myval=val.match(/\d{11}/)
       	if(val&&myval&&myval[0].length==val.length){
       		//alert(val+"  "+myval[0].length+"  "+val.length);
       	}else{
       		alert("手机号不合法");
       	}
       });
