                  ...
                  <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
                        ...
                        <ul id="myTab1" class="nav nav-tabs">
                          ...
                          <li role="presentation"><a href="#add">我发起的</a></li>
                            <li class=" pull-right">
                                 <button type="button" class="btn btn-warning" onclick="window.location.href='${APP_PATH }/project/start.htm'">发起众筹</button>
                            </li>
                        </ul>                  
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-12 column" style="margin-top:10px;padding:0;">
                                            <table class="table table-bordered" style="text-align:center;">
                                              ...
                                              <tbody>
                                              	<c:forEach items="${mymap }" var="tmap">
                                              		<tr>
                                                  <td style="vertical-align:middle;">
                                                    <div class="thumbnail">
                                                        <div class="caption">
                                                            ...
                                                            <p>
                                                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> 已完成 ${tmap.pmpro }% </div>
                                                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 剩余8天 </div>
                                                            </p>
                                                            <br>
                                                                <div class="progress" style="margin-bottom: 4px;">
                                                                  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${tmap.pmpro }%">
                                                                    <span >众筹中</span><!-- progress-bar-danger -->
                                                                  </div>
                                                                </div>
                                                        </div>
                                                    </div>
                                                  ...
                                                  <td style="vertical-align:middle;">${tmap.fmoney }<br>(运费：${tmap.rfreight } )</td>
                                                  <!-- <td style="vertical-align:middle;">1</td> -->
                                                  <td style="vertical-align:middle;">
                                                  	<c:choose>
                                                  		<c:when test="${tmap.fstatus=='0' }">未付款</c:when>
                                                  ...
                                                  <td style="vertical-align:middle;">
                                                    <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                                          ...
                                                          <c:if test="${tmap.fstatus=='0' }"><button type="button" onclick="window.location.href='${APP_PATH }/project/paymoney.do?id=${tmap.fid }" class="btn btn-default">付款</button></c:if>
                                                    </div>
                                                  </td>
                                                </tr>
                                              	</c:forEach>
                                            ...
                                            <table class="table table-bordered" style="text-align:center;">
                                              ...
                                              <!-- <tbody>
                                                <tr>
                                                  ...
                                                  <td style="vertical-align:middle;">1.00<br>(运费：0.00 )</td>
                                                  <td style="vertical-align:middle;">众筹中</td>
                                                  <td style="vertical-align:middle;">
                                                    <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                              ...
                                              <tbody>
                                              <c:forEach items="${list }"  var="project" varStatus="idxStatus">
                                                ...
                                                <tr>
                                                  <td style="vertical-align:middle;">
                                                    <div class="thumbnail">
                                                        <div class="caption">
                                                            ...
                                                            <p>
                                                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> 已完成 ${project.moneyProgress }% </div>
                                                                <!-- <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 剩余8天 </div> -->
                                                            </p>
                                                            <br>
                                                                <div class="progress" style="margin-bottom: 4px;">
                                                                  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${project.moneyProgress }%">
                                                                    <span >众筹中</span>
                                                                  </div>
                                                                </div>
                                                        </div>
                                                  ...
                                                  <td style="vertical-align:middle;">${project.supportmoney }<br><!-- (运费：0.00 ) --></td>
                                                  <td style="vertical-align:middle;">
                                                  	<c:choose>
                                                  		<c:when test="${project.status==0 }">待审核</c:when>
                                                  		<c:when test="${project.status==1 }">众筹中</c:when>
                                                  		<c:when test="${project.status==2 }">众筹成功</c:when>
                                                  		<c:when test="${project.status==4 }">众筹失败</c:when>
                                                  	</c:choose>
                                                  </td>
                                                  <td style="vertical-align:middle;">
                                                    <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                                          <button type="button" onclick="window.location.href='${APP_PATH}/project/toDisplayProject.htm?id=${project.id}'"  class="btn btn-default">项目预览</button>
                                                          <!-- <button type="button" class="btn btn-default">修改项目</button> -->
                                                          <button type="button" onclick="window.location.href='${APP_PATH}/project/doDeleteProject.do?id=${project.id}'" class="btn btn-default">删除项目</button>
                                                          <!-- <button type="button" class="btn btn-default">问题管理</button> -->
                                                    </div>
                                                  </td>
                                                </tr>
