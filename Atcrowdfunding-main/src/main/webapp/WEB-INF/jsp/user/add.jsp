    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  <li><a href="#">首页</a></li>
				  <li><a href="${APP_PATH }${requestScope.url}">数据列表</a></li>
			  ...
			  <div class="panel-body">
				<form id="addForm">
				  ...
				  <div class="form-group">
					...
					<input id="femail" type="email" class="form-control" id="femail" placeholder="请输入邮箱地址" value="">
            	...
            	$.ajax({
            		...
            		success : function(result){
            			if(result.success){
            				...
            				layer.msg("用户已存在，保存用户失败", {time:1000, icon:5, shift:6}); 
            			}
            		},
            		error : function(){
