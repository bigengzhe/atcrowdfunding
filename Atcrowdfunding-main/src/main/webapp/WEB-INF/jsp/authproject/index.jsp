            ...
            <table class="table  table-bordered">
              ...
              <tbody>
              	<c:forEach items="${list }" var="project">
	                  ...
	                  <!-- <td>1</td> -->
	                  <td>${project.pname }</td>
	                  <td>${project.mrealname }</td>
	                  <td>${project.money }</td>
	                  <td>${project.day }</td>
	                  <td>${project.createdate }</td>
	                  <td>
	                      <button type="button" onclick="window.location.href='${APP_PATH}/authproject/verify.do?id=${project.id }'" class="btn btn-success btn-xs">通过<!-- <i class="glyphicon glyphicon-eye-open"></i> --></button>
					  </td>
	                </tr>
              	</c:forEach>
                <tr>
